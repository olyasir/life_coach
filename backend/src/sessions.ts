...
export const SESSIONS: SessionDefinition[] = [
  ...
  },
  {
    ...
    completionCriteria: [
      ...
      "goal_canvas rendered WITH CONFIG containing goalDraft, topValues (from S6), topNeeds (from S7), biggestGap (from S7), and client completed it — including the 3 quality-test checkboxes with note each",
      ...
      "ten_reasons rendered WITH CONFIG containing the final goal, and client completed all 10 reasons",
    ...
    exercises: ["goal_canvas", "ten_reasons"],
    homeworkGuidance:
